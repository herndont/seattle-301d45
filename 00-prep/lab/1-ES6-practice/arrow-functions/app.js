...
// It is an object with values of name, age, and hometown.
// 2. What is "this" when joe.scopeArrow() is invoked?
// It shows in the developer console as undefined. 
// 3. Explain why "this" is different when an arrow function is used.
// This is because there is no 'this' in arrow functions. Therefore, according to MDN, it starts hunting for variables to assign to the this.
